  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        {errorMessage ? (
          <div className="border-2 border-red-600 bg-red-50 px-4 py-3 font-bold text-sm text-red-700">
            {errorMessage}
          </div>
        ) : null}
      </header>
      ...
      <form action={createCategoryAction}>
        <div className="bg-white border-4 border-foreground shadow-[12px_12px_0_0_rgba(0,0,0,1)] p-8 space-y-6">
