...
import { LayoutDashboard, Package, ShoppingCart, Users, Home, Settings, LogOut, Tags, BadgePercent, Store, Megaphone } from "lucide-react"
    ...
    <div className="min-h-screen bg-[#f0f0f0] flex">
      ...
      <aside className="w-64 bg-white border-r-4 border-foreground hidden md:flex flex-col sticky top-0 h-screen z-20">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <AdminNavLink href="/admin/stores" icon={<Store size={20} />} label="Toko" />
          ...
          <AdminNavLink href="/admin/broadcasts" icon={<Megaphone size={20} />} label="Siaran" />
